  ...
  return (
    ...
    <div className="order-product">
      <ul className="order-product__items">
        ...
        <li className="order-product__item">
          Production Time
          <span className="order-product__desc--time">The production of your car mats will take no longer than 5 business days. We aim to make this process as fast and convenient as possible!</span>
        </li>
      </ul>
    </div>
  )
