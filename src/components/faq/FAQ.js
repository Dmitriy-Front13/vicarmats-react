...
const items = [
  ...
  { id: 6, title: "HOW CAN I PAY?", content: "You can securely pay using PayPal or with a credit/debit card. All transactions are processed safely through PayPal’s platform, and we do not collect or store any of your personal data." },
